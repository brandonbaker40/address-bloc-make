   ...
   describe "attributes" do
    ...
    describe "#remove_entry" do
       it "removes an entry from the address book" do
          book.add_entry("Michael Scott", "301.555.5555", "michael@dundermifflin.com")
          ...
          expect(book.entries.first.name).to eq("Michael Scott")
       end
    end
...
# ------------- assignment starts here -----------------
   describe "#import_from_csv" do
     ...
     it "imports the 1st entry" do
       ...
       check_entry(entry_two, "Fred", "555-555-5547", "fred@blocmail.com")
     end
     ...
     it "imports the 2nd entry" do
       ...
       check_entry(entry_three, "Steve", "555-555-3789", "steve@blocmail.com")
     end
     ...
     it "imports the 3rd entry" do
       ...
       check_entry(entry_one, "Todd", "555-555-0215", "todd@blocmail.com")
     end
